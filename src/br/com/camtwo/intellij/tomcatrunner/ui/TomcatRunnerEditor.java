        ...
        CompileTask compileTask = new CompileTask() {
            public boolean execute(CompileContext compileContext) {
                ...
                if (mainOutputDirectory != null) {
                    ...
                    NotificationGroupManager.getInstance().getNotificationGroup("IDEA Tomcat Runner")
                            .createNotification("Tomcat Runner - Couldn't determine the classes folder:<br>Please compile / make your project before creating the conf.", NotificationType.ERROR)
                            .notify(project);
                }
                return true;
            }
